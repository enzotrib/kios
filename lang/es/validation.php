...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción al español de los mensajes de validación por defecto. El
    | marcador :attribute se reemplaza por el nombre del campo (ver la
    | sección "attributes" al final para nombrarlos en español).
    |
    */

    'accepted' => 'Debés aceptar :attribute.',
    'accepted_if' => 'Debés aceptar :attribute cuando :other sea :value.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplaza :attribute por un nombre legible en español. Agregá acá los
    | campos propios de InfoShop a medida que aparezcan en los formularios.
    |
    */

    'attributes' => [
        'name' => 'nombre',
        'shop_name' => 'nombre del comercio',
        'shop_logo' => 'logo del comercio',
