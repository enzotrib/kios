...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
    ...
    <div class="flex justify-between">
        ...
        @if($allRequirementsMet)
            <a href="{{ config('database.default') === 'sqlite' ? route('installer.settings') : route('installer.database') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                Next
